    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_mrgworkday_domain_model_job',
                'foreign_table_where' => 'AND tx_mrgworkday_domain_model_job.pid=###CURRENT_PID### AND tx_mrgworkday_domain_model_job.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
